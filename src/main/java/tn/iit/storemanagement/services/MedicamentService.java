...
import tn.iit.storemanagement.qdsl.IQMedicamentRepo;
import tn.iit.storemanagement.qdsl.QMedicamentRepo;
...
public class MedicamentService {
    ...
    private final IQMedicamentRepo iqMedicamentRepo;

//    protected JpaQueryCreator from (EntityPathResolver pathResolver){
//        return new JpaQueryCreator (entityManager )
//    }
    public MedicamentService(MedicamentDao medicamentDao, CategoryDao categoryDao, IQMedicamentRepo iqMedicamentRepo) {
        this.medicamentDao = medicamentDao;
        this.categoryDao = categoryDao;
        this.iqMedicamentRepo = iqMedicamentRepo;
    ...
    public Collection<MedicamentDto>findByNameAndCategoryName
            (String name){
        return MedicamentFactory.medicamentsToMedicamentDtos (iqMedicamentRepo.findMedicamentByNameAndCategory (name));
    }
